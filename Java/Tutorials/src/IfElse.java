...
public class IfElse {
    public static void main(String[] args){
        ...
        // 20 is greater than 18. If the condition is true, print some text:
        if (20 > 18) {
        ...
        // y (using the > operator). As x is 20, and y is 18, 
        ...
        // we move on to the else condition and print to the screen "Good evening". If the time was less than 
