...
public class JavaNumbers {
    public static void main(String[] args){
        ...
        // and in our tutorial, the int data type is the preferred data type when we create 
        ...
        // This is used when int is not large enough to store the value. Note that you should end 
        // the value with an "L":
        ...
        // you need a number with a decimal, such as 9.99 or 3.14515.
        ...
        // value can have after the decimal point. The precision of float is only six or seven decimal digits, 
